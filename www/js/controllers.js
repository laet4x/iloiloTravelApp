...
.controller('HotelsCtrl', ['$scope', '$stateParams', '$state', '$rootScope',
  ...
  $scope.hotels = [
    {  id: 1,title: 'Hotel Del Rio',img: 'hotel.jpg',lat: 10.700133, lng:122.552114},
    {  id: 2,title: 'Sarabia Manor' ,img: 'hotel.jpg',lat: 10.699647,lng: 122.556336},
    { id: 3,title: 'Century 21', img: 'hotel.jpg',lat: 10.700421, lng:122.566201},
    { id: 4,title: 'Days Hotel', img: 'hotel.jpg',lat:10.701329, lng:122.567958}
  ]
  ...
  $scope.showMap = function(lat, lng) {
      console.log(lat, lng)
      $state.go('app.hotel_map', { lat: lat, lng: lng});
  }
}])
